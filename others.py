...
# Переменные / функции
bot_token = '1436975473:AAFScGmahFQywhAjUFWPxiuvZTkqLfhznNE'		# 
admin_user_id = 1468568711											#  
channel_id = -1001171699314									# 

token = '' 							# qiwi token
phone = '+79611437929'												# qiwi number

secret = '547e5bd2b5eab5334cfb5230c4373c6934820833'   # CRYSTAL PAY SECRET 1
login = 'lucky32532'    # CRYSTAL PAY LOGIN


manager = "Optionew" # username мэнеджера без @
group = "@otziv_vaper" # канал с отзывами, готовый вариант, можно оставить

bot_name = "hqd_juul_shopbot" #username бота без @
